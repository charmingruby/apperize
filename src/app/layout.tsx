  ...
  return (
    <ClerkAuthProvider>
      <TrpcProvider>
        ...
        scroll-smooth font-sans bg-background-default text-foreground scrollbar-thin scrollbar-track-background-highlight-main scrollbar-thumb-background-highlight-dark
      `}
          >
            <main>{children}</main>
          </body>
